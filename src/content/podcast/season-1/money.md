...
[01:16] **Nadia:** Fundamentally, if you think of churches as these are just places where certain groups of people who adhere to the same concepts have decided to cluster, then churches can come up really organically but there's some point where a church wants to become more formalized. They register as an organization legally. They have a physical space that people meet in and all those things require more resources.

[01:51] **Henry:** Exactly. That's what I was saying before about what's the difference between a house church which is just a few people, maybe it isn't as formal and then another extreme is a [mega church](https://en.wikipedia.org/wiki/Megachurch) where they're huge, they might have millions of dollars.

[02:15] **Nadia:** What's the point at which a church has too much money or too many resources? Is that even possible? Depending on what you subscribe to, maybe a mega church is just maximizing its impact and reach. Whereas a much smaller church might only reach 30 people.

[02:38] **Nadia:** Maybe a mega church is able to spread its message to thousands of people and make thousands of people feel like they're part of something. If you're just looking at it in this dollar and cents kind of way, "Well, why not just grow and grow and grow?" But then we intuitively feel like somehow it goes against the spirit of what a spiritual practice should be, which is really similar to open source...

[03:08] **Nadia:** To some extent, people are, especially now, more comfortable with the idea of projects having more resources or funding or volunteers or whatever but there are still some feeling or expectation that you don't really get too big either and same with the non-profits sector. I don't really know where that line falls where suddenly it just doesn't feel right anymore.

[03:34] **Henry:** (laughs) That's really hard. I don't think we'll ever really have a rule on what that really is. Maybe, like you said, you feel weird about it but it's hard to say, "They're not doing it right or they're taking too much." And even if you say that, you'll feel bad about calling people out.

[03:57] **Henry:** With the mega churches, you're saying it makes sense that you can be more efficient with money if you're able to pull it together but that's also why we have issues with people not really understanding the needs of the people that they serve and it might be too generalized.

[04:21] **Henry:** The advantage of having a small local church is that they understand the needs of the area that they're in and they can be more effective in that way 'cause they're closer to the people versus a huge organization, it's just not easy or maybe impossible for them to really know what's needed.

[04:44] **Nadia:** There's a good question about where should decentralization and centralization exist, at what tier of organization? Even a small local church, most of them ascribe to some concept, some branch or sect of that religion that is a much higher thing. It might be a small church but it's an Episcopal church or a Protestant church and so the concepts that you're ascribing to...

[05:22] **Nadia:** Everyone has this shared understanding of something that is much bigger than that church but the manifestation of it comes in this very small organization, whereas... we're talking about these very large churches where maybe they're just centralizing at the wrong level. Maybe churches themselves function better when they're smaller and more agile but they're still part of this much bigger centralized concept, if that makes sense.

[05:54] **Henry:** That's true, it's not like they're all isolated. Definitely don't want that to be the case where churches either partner together or if they're in the same denomination then they are aligned and there are people, maybe the leaders that work together, to talk about high level things. But the way you're effective is that you're sent out, and where you're at, instead of... you don't have enough context into what's going on, so you have to, like you said, have that level of centralization and decentralization.

[06:39] **Nadia:** Do you know any examples of churches in the same physical location that split off into two different churches? I'm sure there are a lot of examples of that but I don't know any personally. I was trying to think, do they split off because there's a difference in beliefs or philosophies between those two churches or just because the church had too many members and they had to start a second chapter in the same area? What's the natural limiting factor in a church splitting off? Basically, when's the right time to fork?

[07:19] **Henry:** It's a good open source term.

[07:22] **Nadia:** Is it because you have a difference in the way that you wanna carry on your operations or is it because there are too many people and you can't organize that many people efficiently in church?
...
[08:19] **Henry:** It's a difficult decision that people might have to make, or something happens, like some event where it's like, "Okay, maybe one leader decides to do their own thing." But it's also, it actually is kinda common for churches to split up if quote, unquote, "it gets too big," and maybe it depends on the location, like maybe if it's in New York and then it's, there's no enough space.
...
[10:08] **Henry:** And it comes from the [Old Testament](https://en.wikipedia.org/wiki/Old_Testament) and I think the background is basically that if, let's say, God appoints people to be staff on a church, say pastors or different leaders, that kind of thing, they can be focused on serving the people that go to that church and everyone else that is the lay people, they work and they can pay part of their income to support those people.

[10:39] **Henry:** And so that carries over now where there's no, maybe before, it was required, like a law where it's like, "Okay, you have to give this much of your money." Now, it's more, it's the same thing, but it's not a rule where it's more about like they'll say something more about, you should have a cheerful heart in giving and that there's no like, "Oh, you have to give 10% kind of thing," but it's more give that of abundance that you've been given.
...
[13:56] **Nadia:** I was thinking about this post that [Feross](https://twitter.com/feross) did a while ago. I think it was for [WebTorrent](https://webtorrent.io), where he just [opened an issue](https://github.com/standard/standard/issues/744) and said like, "If you're using this ..." I think specifically, "If you are a company using this, just post on this thread," and got a whole bunch of people that posted saying, "Hey, our company is this," which I thought was a really simple but (laughs) great idea to, I don't know. If you're a project and you don't know which companies are using you, why not just ask and see who responds. And I think he used that to help inform where to get sponsorships for his work.

[14:33] **Henry:** Yeah, that makes sense. That's why a lot of open source projects, we have that [users page](https://babeljs.io/users) for branding or whatever. It's funny 'cause I remember joking before, technically that page is a good ... Like, we could rename that page to say "all the companies that don't pay us money", but (laughs) ...

[14:50] **Nadia:** But that would not be great if ...

[14:51] **Henry:** Yeah, it wouldn't be great. No, I think there's so much to say that (laughs) ... I think that's kind of an issue even with, in church too where they're trying to embrace technology but then, there might not be a lot of people that are in the leadership of the church to understand technology well and then they're maybe like, "Oh," some people are like, "Oh, we gotta add online giving." Other people are like, "No, that kind of takes away from giving because you wanna feel like ..."

[15:25] **Henry:** Kinda like how now we have digital bibles and then there's a physical one and then there's something about reading a physical book that's different from the digital one and giving out your check or your money, it's like, that physical act says something differently than just, kind of, what if you did the automated, "Every month, I give this much," and you kind of forget about it.
...
[18:03] **Nadia:** But it's just like, it's just not the same as holding a physical book and maybe people like me will eventually die off and everyone will use Kindles but there is just something irreplaceable about is, so, yeah.

[18:14] **Henry:** Ah, yeah.

[18:14] **Nadia:** (laughs) Fundraising.

[18:18] **Henry:** I don't think that's true. I don't know if "our kind of people" ever die off. I kinda feel like every time we add a new medium, it, like books, they don't really go away and I feel like even if you're used to digital, you always go back to physical for some reason. I think it's maybe, we've kind of got caught up in this whole, everything is about your mental state and psychology and you forget we're actually people in a body and that actually affects how we perceive the world, and so that sense of physical touch really means something ...

[18:54] **Nadia:** Yeah.

[18:55] **Henry:** ... Maybe.

[18:57] **Nadia:** It's interesting to think about. There is a dad who is telling me that apparently among kids right now, super tactile clothing is all the rage, things that are really ...
...
[20:08] **Henry:** It kinda reminds me of, I think I was talking to someone and they were talking about how all the new cars, they have touchscreens for all the buttons but then a lot of older folks, they kinda, they have this muscle memory with the buttons on the car, like how do you turn on the AC and all that stuff, but now it's all just a screen and they have lost the memory of where things are 'cause it could be anywhere on the screen and maybe you have a UI update and then now everything's different again.
...
[22:27] **Nadia:** And so yeah, I guess I'm wondering, what are the actual takeaways for open source around, what does that message look like, if the funders are people that are coming from your community, they are people that, maybe companies that use or rely on your project, why would you ideally want them to be giving or not? And then part two, are they interested in your views on this given that Babel.. like people give for lots of different reasons, I'm sure.

[22:58] **Henry:** I mean, even in the church setting, there's a huge expectation, and I think that would be great if we had that, an open source 'cause clearly it's not there and maybe now it's kind of getting there or at least people are like, "Oh, open source projects are actually getting money," even though it's basically nothing.
...
[24:47] **Henry:** Like, you should, even in work, we should strive to be the best person that we can be, but then we can't derive our identity from, and our worth from that, the outcome of the work. And I basically talked about that in my talk. It's like, you can spoil your life out and doing open source and then people don't appreciate you and then now you suddenly feel like you're not worthy anymore.

[25:11] **Henry:** And I guess it's the same with giving. It's like if you give expecting all the stuff and then ... Say you gave all this money to open source and then they didn't release the thing in the time that you expected and now you start feeling like now they owe you.

[25:28] **Nadia:** Or that's why it's different in open source 'cause I mean, you have companies that are relying on this for their work, right? It is fundamentally just a different kind of relationship than a spiritual private practice. And so, I guess, yeah, I'm wondering, longterm, if we see project being well-supported financially when they need it, is it gonna look, is that gonna happen because projects have gotten good at building this relationship with companies and kind of suggesting that your participation in this is a way for you to be closer to the project.

[26:10] **Nadia:** Like, I think that's what [Sean Larkin](https://twitter.com/TheLarkInn) has done really well with Webpack of, they have office hours and companies see these tangible benefits to giving and that's why they keep giving, or is it gonna just kind of be this, it will take years and years to kind of have this be ingrained but the idea then maybe it's just a thing that you do the same way that tithing is something that you do because you're not expecting anything out of it but you're doing it because it's just the right thing to do.
...
[31:00] **Henry:** There's all this responsibility and burden and I figured that if I'm already kind of doing this in my regular work with open source, I didn't intend to be a leader, but here it's like it's not that different and I feel like I can learn a lot from both. And I think in the same way ...
...
[33:17] **Henry:** I think we talked about church health and project health a while ago and just a very basic point is that, the way that money is related to that is that the more people that attend, the more money that you might potentially get because more people might tithe. And so people like to use the numbers in church growth to signify whether a church is doing well, even though that doesn't necessarily mean anything 'cause I could say, same with open source, we raise a lot of money, that doesn't mean we're doing well because maybe that person's burnt out, they don't know what to do with the money or they don't know how to find people to, I guess, quote unquote, "hire" to help.
...
[34:11] **Henry:** For attendance, I suppose.

[34:14] **Nadia:** Yeah, as an attendant, a contributor or user.

[34:20] **Henry:** (laughs) Well, for them is more that, because there's more people and more people will give back, so that would be probably how many companies are giving back. Yeah, 'cause I think number of people helping is more burden in some sense.

[34:34] **Nadia:** Right.

[34:35] **Henry:** I don't know if we touched on this but, yeah. What happens when you have money, and how are you supposed to use it, in church we use the word "stewarding," right? It's like, when you do have money, you can be generous and give it away and help other people or you can kind of waste it and squander it.

[34:59] **Henry:** And I think one of the hardest things to do is when you do have money, whether it's personally or in church or an open source, it's like making sure that you use it well. And the word "stewarding," I think is great because it's saying, at least in a church setting, it's saying that that money is not yours and it's been given to you, and so you have a responsibility to use it well.
...
[38:29] **Nadia:** But I think there was also just a criticism of, "You shouldn't have an install message 'cause tons of people work on this that aren't getting directly paid by these donations to do it." There are a lot of ... Like, I think that is sort of the ethical problem when you have volunteers working on your organization where some people are getting paid but what if I feel like I should get paid, and I'm just contributing for free and now I don't want to 'cause I can see that this maintainer over here gets paid to work on it, and that can be, yeah, just really difficult.
...
[43:12] **Nadia:** Something I came to realize a while ago that has just made me so much less angsty about all of this is just accepting that there are gonna be so many different ways for people to do a thing that they like to do and there's never gonna be this one correct path that will solve everything for everyone because everyone is different, everyone has different motivations.
