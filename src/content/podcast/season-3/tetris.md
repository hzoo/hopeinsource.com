...
[10:43] **Stephen:** And there's a link to open source there, of course, right. Because when I read that, I always think of it [Richard Stallman](https://en.wikipedia.org/wiki/Richard_Stallman), saying the justification of copyleft is that it's not the best kind of free if others are free to take away the freedom, if you like. So the sort of very liberal BSD style approach to open source where others can basically capture your efforts and then release something that's not free as a derivative of that.
...
[12:15] **Stephen:** Right, exactly. It just reminds me of the film, [Three Colours: Blue](https://en.wikipedia.org/wiki/Three_Colours:_Blue) with Juliette Binoche, where she tries to cut herself off from society and just finds that whether she likes it or not, her life is sort of intertwined with those of others. Software has this strangely dominating effect though, right? Because if you depend on some software, then you're at the mercy of the person on the other end. They can change things up on you and you just have to dance to their tune.
