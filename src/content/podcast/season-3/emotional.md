...
[00:00] **Henry:** So I have Omar with me. I think your tweets are interesting and it'd be interesting to almost analyze them. Cause I think you said you were planning on doing that for yourself to see what comes up, right?
...
[01:31] **Omar:** I mean, whenever I kind of say these things, like the tyranny of lists or whatever. I don't want people to think that I'm making some generalization, that all lists are bad all the time or anything like that.

[01:41] **Omar:** But I think people probably lean too much on the side of lists. It's sort of an easy out, Oh, I have a bunch of stuff. I'm going to make a list of it. And often I'm going to tell the computer to sort it or whatever. I often say these things because I want to push back and get people to think about more radical ways of presenting information.

[01:58] **Omar:** But I think that the problem with lists is that you're giving up a lot of control over how the stuff is organized.

[02:06] **Omar:** Often if you have a list of emails, you can't put emails that belong together, together. You can't space them different distances from each other. Because everything is the same, it is uniform with space. If it's sorted, then you don't even have control of what order they’re in.
...
[02:21] **Omar:** And I think often the reason people use a list is not a great reason. It's that a list is something that's easy to do on the computer. Because iOS gives you a list control or you can make an HTML list element, or your Mac finder uses lists by default. Or a list is easy to type in your word processor or a note taking app.

[02:40] **Omar:** If you were trying to pick the best way to represent the information, maybe you wouldn't pick a list. If you actually had a choice, you had other options that were equally straightforward.

[02:49] **Henry:** Hmm, I guess even applying that, cause we were trying to make a list, I guess, of your tweets. And then I was already saying, why can't I drag these around and create categories and space? So that's kind of funny.
...
[05:23] **Omar:** I think these things all kind of come out of this cohesive ideology of how maybe software should work.
...
[06:02] **Omar:** And I think often there are these aesthetic choices or there are these emotional choices or there are different goals people have. I think emotions are a big deal in programming. I think most of the work in programming is managing your own feelings about it.
...
[07:04] **Omar:** But I think often what people end up talking about and what gets all the investment are these tools that maybe make sense in one context, which shouldn't necessarily get generalized to other places.
...
[08:38] **Omar:** Right. I think once you start working on something, a lot of the time you end up caring about it. So I sometimes think it's kind of dangerous to start working on something where you're lukewarm on it. Not because you might hate it, but because he might love it, and then you kind of turn into a different person.
...
[12:56] **Omar:** Yeah, I wasn't around in the seventies, but I like to think that it would have been a really weird phrase to hear, personal computer. Because you would think of a computer as being this thing that fills the whole room. Like if I told you about a personal factory or a personal warehouse, like some really expensive, capital intensive thing that is now like shrunk down to your desk.
...
[13:27] **Omar:** Right. I think the scale is part of why it's shocking, but it's also the ownership. A computer is not just something that's huge, it's also something where IBM makes it and they sell it to airlines manage their payroll.

[13:38] **Omar:** So there's this reversal of, Oh, what would I do with something like that? That's such a weird concept. I like trying to highlight that these things were actually strange at some point. And should maybe be strange again.

[13:51] **Omar:** It kind of reminds me of religious scriptures in some ways, where a lot of these things that are in the Bible or the Quran or whatever would have been radical at the time. And people have repeated them and so they sound like just something you say. But I think it's always worth thinking about them in the context of their time and trying to bring back that freshness and that radicalism.

[14:11] **Henry:** That's a really good point, honestly. It's sort of like the idea where if you say the same thing over and over. Sometimes it feels like it becomes meaningless, but if you truly believe in it, then every time you repeat it, it makes you feel a positive way.

[14:25] **Henry:** And if you think about the Bible, like that first verse, that God created the universe. That should be such an impactful statement. But when we hear that, it's just kind of like, Oh, whatever. But if you thought about it, wow, that's huge, right?
...
[15:23] **Omar:** But I don't believe that, I think that's nonsense. I think that content and presentation are always inseparable. And often when you do this naive translation of stuff that's in a physical medium into your computer screen, you lose a lot of important parts of the presentation. So I want to go back and highlight those things so people notice them.
...
[16:36] **Omar:** To be clear, I think there is a place for reading on your phone and I don't think there's necessarily anything wrong with it, but I think it would be good if we paid attention to what things are we losing and are there ways to kind of bring them back or to do new and better things? Rather than just thinking that we've accurately translated this experience.
...
[18:05] **Omar:** And often we go back and look at that as this purely cultural thing, when actually it's also solving a specific problem that they have that for a while we didn't have any more. I guess now we have the problem again.
...
[19:20] **Omar:** And we were talking about how the daycare is like, well, if you don't want to watch your kids, you can just not look at the camera. But to me, there's a fundamental.. You've changed the whole dynamic by having this monitoring thing in place and by people knowing that you can use it. It's not like you can just add these things linearly and it has a linear effect and you can just opt out. Once it's there, it changes everything around it.
...
[20:26] **Omar:** Right, almost treating technology as this separate category from rituals, or art, or culture. Almost that alone, there's already something there where you can feel like you either have to adopt it wholeheartedly or reject it wholeheartedly.

[20:41] **Omar:** I think you should treat technology like anything else where you kind of take the things that you think are valuable and maybe don't take the things that you don't think are valuable. Instead of treating it as this autonomous force.
...
[21:15] **Omar:** Another example, is if you remember computers in like the late 1990s, early two thousands, all the buttons were like 3d. They like stuck out of the toolbar, right. And then once people learned what things you could click on, they didn't have to be 3d anymore. Now most of the buttons on your computer, they don't have those bezels.

[21:33] **Omar:** So there's always this time dimension, people learn and then that makes new kinds of interactions possible, or it means you can throw away some of the scaffolding that you had in the beginning.

[21:44] **Omar:** A corollary of this is also kind of like that. If there's a successful product like the iPod, it might not actually be that you could go back 10 years and they would be a success, or it might not actually be that Google could have made the iPod instead of Apple.
...
[22:45] **Omar:** And I think that's related to the idea of testing things on yourself. I feel like there's a way of knowing where you have yourself, or you have people you know by name and you kind of are able to work that way.

[22:57] **Omar:** And then there's a way of knowing that's more, let's try and scale things really big and then know things by statistical means A/B testing. And obviously I'm a lot more sympathetic to the former.
...
[23:54] **Omar:** I like that because it suggests you can build up faith or you can build up these other forms of knowledge.

[24:01] **Omar:** There's the kind of logical notion of faith, which is that I believe this, or I don't. And I think this is like a more true way of dealing with knowing things where often you have some relationship with the thing.
...
[24:29] **Omar:** Right. It's just like logical predicates. And I think that's more accurate to most things that are actually worth knowing, right? Programming, or playing a musical instrument, or playing sports or whatever. These things are not some set of facts.
...
[29:25] **Omar:** But the fact that people want to do that, there's something to learn from that. About what kinds of things people want to do, and how those aren't suited to the prescription.

[29:37] **Omar:** Whenever you see people doing things like that, where you kind of want to guilt them into, don't do that. But I think the reaction should be opposite. We should be trying to learn from that. Or people taking tons of screenshots and covering their desktop with screenshots. Why is that? I think it's because there's something better about screenshots.
...
[30:12] **Omar:** Yeah, exactly. The point of computers is to help people do what they want to do. And so if we can change the computer instead of changing what people are doing, I always feel that's a better option.
...
[30:40] **Omar:** But I think there are a lot of good things about spreadsheets. And there are a lot of things to learn from them. And we shouldn't be so quick to interpose ourselves.
...
[31:11] **Omar:** In the same way that I think we should learn from spreadsheets or taking screenshots or barfing inline CSS everywhere. I think we should learn what we can from social media. Why are all these interactions so satisfying? Can we take that and apply it in other contexts like programming?
...
[32:31] **Omar:** That's part of it, but I think whenever people have to switch between what feel like different tasks, that's always a huge barrier. And I think switching from, I'm working on my project, to, Oh, I have to go on GitHub and fork this project and then re-clone it and change it in my package manager configuration, that's a huge task switch and that's why people dread doing that.

[32:54] **Omar:** And you know, one thing I bring up sometimes. This is also the reason I think people often don't want to use a debugger. Yeah. It's a huge task switch from running your program to, Oh, now I have to use this different debugger interface that I maybe don't use that often. I have to go out of my way to click the debugger button.

[33:10] **Omar:** But I think once you start looking for these, they're kind of everywhere. And maybe rationally you've given people all the tools that they needed. But emotionally, people are not going to be eager to use them if it takes them out of their flow.
...
[34:11] **Omar:** Right. One solution that people have occasionally used, is like, you just do all the programming in the debugger. And I think that's maybe something that's worth looking at.

[34:19] **Omar:** People often talk about visualization, data visualization of what your code is doing. This is a lot often how people see like Bret Victor's work is that it's visualizing your code. But I'm always uncomfortable with the framing of visualization, because to me that implies that the visualization is something you have to go out of your way to make, you have to click a button or insert visualization hooks.
...
[36:57] **Omar:** It also reminds me, there's a great book \[A Small Matter of Programming\] by Bonnie Nardi, who's an anthropologist on end-user programming. And she points out that this is kind of the genius of spreadsheets.
...
[38:06] **Omar:** I don't know if you've seen this, and the way it works is like, His prototype, you import the JSON and then it immediately renders all of it on the screen. It's like a list of stuff. And then you can incrementally tweak the way that list looks into the interface you actually want. So you never have to write that loop of making all the elements. You start out with all the elements.
...
[38:35] **Omar:** And the three things I think of are like screenshots, where you can take a screenshot of anything on your screen. I make a screenshot app, but I don't need to know what kinds of stuff can be valid screenshots.

[38:46] **Omar:** The real world. And this is kind of what Dynamicland did, where if you have a program that's printed out, you can put post it notes on it, or you can scribble on it or whatever. The system doesn't prescribe what kinds of things you can do.

[38:58] **Omar:** And then the third example is actually file systems on your computer, where you actually have all these operations you can do to files and you can move them around and put them in different places. If you have a Word file, Word doesn't prescribe where you can put that file.
