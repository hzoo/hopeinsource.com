      ...
      <>
        ...
        <blockquote className="twitter-tweet tw-align-center" data-lang="en">
          <p lang="en" dir="ltr">
            ...
            <a href="https://twitter.com/nayafia?ref_src=twsrc%5Etfw">
              @nayafia
            </a>{" "}
            and{" "}
        ...
        >
          <p lang="en" dir="ltr">
            Just listened to the first episode and one of the things that came
            to mind is the connection between motivation for giving and
            anticipated benefits/rewards, as with the prosperity gospel
            movement. I wonder what the parallels between that and Open source
            might be
          </p>
        ...
        <blockquote className="twitter-tweet tw-align-center" data-lang="en">
          <p lang="en" dir="ltr">
            ...
            commitment to learn and explore some of the greater questions in
            life with a childlike heart of awe and wonder.
          </p>
